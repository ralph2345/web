...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['add_product'])) {
        ...
        if ($_FILES['product_image']['size'] > 3 * 1024 * 1024) {
            ...
            if ($imageDimensions[0] != 225 || $imageDimensions[1] != 225) {
                $message = 'Sorry, image dimensions should be exactly 225x225 pixels.';
            } else {
        ...
        function validateImage() {
            ...
            img.onload = function() {
                if (this.width !== 225 || this.height !== 225) {
                    alert('Image dimensions should be exactly 225x225 size.');
                    return false;
                }
            };
