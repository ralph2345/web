...
// Fetch order details from the database before any modification
    ...
    <div class='order-message-container'>
        <div class='message-container'>
            ...
            <div class='customer-details'>
                <p>Order No.: <span>{$order_id}</span></p>
                <p>Your Name: <span>{$name}</span></p>
                <p>Your Number: <span>{$number}</span></p>
                <p>Your Email: <span>{$email}</span></p>
                <p>Pickup Date: <span>{$pickup_date}</span></p>
        ...
        <form action="" method="POST" id="checkoutForm"> <!-- Form action is set to current page -->
            <div class="order-summary">
                <?php foreach ($items as $index => $item): ?>
                    ...
                    <input type="hidden" name="items[<?php echo $index; ?>][total_price]" value="<?php echo $item['total_price']; ?>">
                <?php endforeach; ?>
